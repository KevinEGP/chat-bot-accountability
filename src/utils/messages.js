...
client (string or null), identifier (number or null) is related to "Caso, Modelo o Protesis", amount (number or null), method (Nequi|Efectivo).

Input message:
"""${text}"""
  
Return JSON like:
{"action":"Deuda","client":"Ana","identifier":"1234","amount":25000,method":"Nequi"}
`,
